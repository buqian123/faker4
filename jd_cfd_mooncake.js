...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githu1231busercontent.com/Aaron-lv/updateTeam/master/shareCodes/cfd.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdew21312qelivr.net/gh/Aaron-lv/updateTeam@master/shareCodes/cfd.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdel213ivr.net/gh/Aaron-lv/updateTeam@master/shareCodes/cfd.json')
  }
