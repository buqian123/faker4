...
async function barGain() {
  let res = await getAuthorShareCode2('https://raw.github3243usercontent.com/Aaron-lv/updateTeam/master/shareCodes/jd_barGain.json')
  if (!res) {
    $.http.get({url: 'https://purge.j3432sdelivr.net/gh/Aaron-lv/updateTeam@master/shareCodes/jd_barGain.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode2('https://cdn.jsde23432livr.net/gh/Aaron-lv/updateTeam@master/shareCodes/jd_barGain.json')
  }
...
async function bigWinner() {
  let res = await getAuthorShareCode2('https://raw.githubu23432sercontent.com/Aaron-lv/updateTeam/master/shareCodes/bigWinner.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdel23432ivr.net/gh/Aaron-lv/updateTeam@master/shareCodes/bigWinner.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode2('https://cdn.jsde32432livr.net/gh/Aaron-lv/updateTeam@master/shareCodes/bigWinner.json')
  }
