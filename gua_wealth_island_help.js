...
!(async () => {
  ...
  let getShareNums = 0
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('https://raw.githu234busercontent.com/smiek2221/updateTeam/master/shareCodes/wealth_island_code_one.json');
    if(!$.innerInviteList[0]) $.innerInviteList = await getAuthorShareCode('https://git234ee.com/smiek2221/updateTeam/raw/master/shareCodes/wealth_island_code_one.json');
    res2 = await getAuthorShareCode('https://raw.githubuserc324ontent.com/smiek2221/updateTeam/master/shareCodes/wealth_island_code.json');
    if(!res2[0]) res2 = await getAuthorShareCode('https://gite234e.com/smiek2221/updateTeam/raw/master/shareCodes/wealth_island_code.json');
